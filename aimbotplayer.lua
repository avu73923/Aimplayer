loadstring(game:HttpGet(("https://raw.githubusercontent.com/VanThanhIOS/OniiChanVanThanhIOS/refs/heads/main/uimain.txt")))()
       ...
       local Window = MakeWindow({
         Hub = {
         Title = "Việt Hoàng iOS",
         Animation = "Script Săn Bounty"
         },
        Key = {
        KeySystem = true,
        Title = "Việt Hoàng iOS / Script Săn Bounty",
        Description = "",
        KeyLink = "",
        Keys = {"VietHoangios2014"},
        Notifi = {
        Notifications = true,
       ...
       MinimizeButton({
       Image = "http://www.roblox.com/asset/?id=109006615554747",
       Size = {40, 40},
...
loackplayerslabel.Text = "Văn Thành IOS"
...
NamePlayers.Text = "Việt Hoàng iOS"
